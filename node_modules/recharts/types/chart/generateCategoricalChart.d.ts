...
import { LayoutType, StackOffsetType, CategoricalChartOptions, Margin, ChartOffset, BaseAxisProps, Coordinate, ChartCoordinate, TickItem, AxisType } from 'recharts/types/util/types';
import { AccessibilityManager } from 'recharts/types/chart/AccessibilityManager';
import { CancelFunction } from 'recharts/types/util/deferer';
...
export declare const generateCategoricalChart: ({ chartName, GraphicalChild, defaultTooltipEventType, validateTooltipEventTypes, axisComponents, legendContent, formatAxisMap, defaultProps, }: CategoricalChartOptions) => {
    new (props: CategoricalChartProps): {
        ...
        renderCursor: (element: ReactElement) => React.FunctionComponentElement<any> | React.DetailedReactHTMLElement<{
            ...
            key: string | number;
            className: string;
            points: import("recharts/types/util/cursor/getRadialCursorPoints").RadialCursorPoints | [Coordinate, Coordinate];
            top?: number;
            bottom?: number;
            left?: number;
            right?: number;
